...
export default function CatastroSearch() {
  ...
  const loadData = async () => {
    try {
      ...
      // --- 💡 SOLUCIÓN UTF-8 APLICADA AQUÍ ---
      // Usamos response.blob() y FileReader para forzar la lectura como UTF-8
      ...
      reader.onload = (event) => {
        ...
        for (let i = 1; i < lines.length; i++) {
          // Usamos una expresión regular simple para manejar comas dentro de comillas si es necesario, 
          // aunque el split por coma sigue siendo la base para este formato simple.
      ...
      // Detenemos la función aquí para que el setLoading(false) se ejecute dentro de reader.onload
      return; 
    } catch (error) {
